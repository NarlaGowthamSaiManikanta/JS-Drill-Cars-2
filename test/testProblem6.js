...
const extractingAudiAndBMWCars = require('../problem6.js');
const audiAndBMWCars = extractingAudiAndBMWCars(inventory);

console.log(JSON.stringify(audiAndBMWCars, null, " "));