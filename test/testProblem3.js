...
const findingSortedCarModels = require('../problem3.js');
const sortedCarModels = findingSortedCarModels(inventory);

for (carModelIndex = 0; carModelIndex < sortedCarModels.length; carModelIndex++) {
    console.log(sortedCarModels[carModelIndex]);
}